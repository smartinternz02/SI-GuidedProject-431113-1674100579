...
# load the model 
naive_bayes_model = pickle.load(open(r'D:\ibm\hotel\training\naive_bayes_model.pkl', 'rb'))
logistic_regression_model = pickle.load(open(r'D:\ibm\hotel\training\logistic_regression_model.pkl', 'rb'))
cv_naive=pickle.load(open(r'D:\ibm\hotel\training\tranform_naive.pkl','rb'))
cv_logistic=pickle.load(open(r'D:\ibm\hotel\training\tranform_logistic.pkl','rb'))
